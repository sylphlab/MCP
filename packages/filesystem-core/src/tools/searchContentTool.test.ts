...
import { searchContentTool, SearchContentToolInput } from './searchContentTool';
...
describe('searchContentTool', () => {
  ...
  // Helper
  const createInput = (paths: string[], query: string, options: Partial<Omit<SearchContentToolInput, 'paths' | 'query'>> = {}): SearchContentToolInput => ({
      paths,
      query,
