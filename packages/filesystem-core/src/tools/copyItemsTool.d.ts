...
export declare const CopyItemsToolInputSchema: z.ZodObject<{
...
export declare const copyItemsTool: McpTool<typeof CopyItemsToolInputSchema, CopyItemsToolOutput>;
//# sourceMappingURL=copyItemsTool.d.ts.map