...
import { startMcpServer } from '@sylphlab/tools-adaptor-mcp'; // Import start function
const require = createRequire(import.meta.url);
const { name, version, description } = require('../package.json'); // Import metadata directly
import path from 'node:path';
import { fileURLToPath } from 'node:url';
import type { Tool, ToolExecuteOptions } from '@sylphlab/tools-core'; // Import McpTool type
